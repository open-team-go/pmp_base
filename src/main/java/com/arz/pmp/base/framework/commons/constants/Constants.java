...
public final class Constants {
    ...
    private static final String REGEX_INTERCEPTOR_AUTH_OFF_STR =
        "(/)|(/configuration/.*)|(/.*swagger.*)|(/.*/api-docs.*)|(/webjars/.*)|(.*\\.html.*)|(.*\\.js.*)|(/favicon.ico)|(/back/admin/login.*)|(/front/user/login.*)|(/front/user/register.*)";
     ...
     * 手机号码正则
     */
    public static final String REGEX_PHONE_NO_STR = "^\\d{11}$";
